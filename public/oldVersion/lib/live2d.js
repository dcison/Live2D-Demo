(function() {
    ...
    O._$6 = function(aC) {};
    O._$Jf = function(aH, aE, aD, aG, aC) {
    ...
    w.prototype._$og = function(aC) {
        ...
        O._$Jf(this._$mk, 0, aD, 0, this._$mk.length);
        this._$mk = aD;
        var aE = new Array();
        O._$Jf(this._$1j, 0, aE, 0, this._$1j.length);
        this._$1j = aE;
    };
    function aB() {}
    ...
    aB._$Nd = function(bQ, bR, a0, aD, bx, aY, bS, bC) {
        ...
        if (aI <= 0) {
            ...
            if (aI == 1) {
                ...
                var bO = 1 - bY;
                for (var bo = 0; bo < aE;) {
                    aY[aL] = bl[bo] * bO + bk[bo] * bY; ++bo;
                    aY[aL + 1] = bl[bo] * bO + bk[bo] * bY; ++bo;
                    aL += bC;
                }
            } else {
                if (aI == 2) {
                    ...
                    var bG = bW * bY;
                    for (var bo = 0; bo < aE;) {
                        aY[aL] = bX * bl[bo] + bV * bk[bo] + bH * aU[bo] + bG * aT[bo]; ++bo;
                        aY[aL + 1] = bX * bl[bo] + bV * bk[bo] + bH * aU[bo] + bG * aT[bo]; ++bo;
                        aL += bC;
                    }
                } else {
                    if (aI == 3) {
                        ...
                        var bJ = bU * bW * bY;
                        for (var bo = 0; bo < aE;) {
                            aY[aL] = b3 * a5[bo] + b2 * a4[bo] + bP * aK[bo] + bN * aJ[bo] + b1 * a1[bo] + b0 * aZ[bo] + bL * aG[bo] + bJ * aF[bo]; ++bo;
                            aY[aL + 1] = b3 * a5[bo] + b2 * a4[bo] + bP * aK[bo] + bN * aJ[bo] + b1 * a1[bo] + b0 * aZ[bo] + bL * aG[bo] + bJ * aF[bo]; ++bo;
                            aL += bC;
                        }
                    } else {
                        if (aI == 4) {
                            ...
                            var aO = bT * bU * bW * bY;
                            for (var bo = 0; bo < aE;) {
                                aY[aL] = bf * by[bo] + bd * bw[bo] + aR * bj[bo] + aQ * bh[bo] + a7 * bt[bo] + a6 * bs[bo] + aN * a9[bo] + aM * a8[bo] + bn * bB[bo] + bm * bz[bo] + aW * bq[bo] + aV * bp[bo] + bc * bv[bo] + ba * bu[bo] + aP * bi[bo] + aO * bg[bo]; ++bo;
                                aY[aL + 1] = bf * by[bo] + bd * bw[bo] + aR * bj[bo] + aQ * bh[bo] + a7 * bt[bo] + a6 * bs[bo] + aN * a9[bo] + aM * a8[bo] + bn * bB[bo] + bm * bz[bo] + aW * bq[bo] + aV * bp[bo] + bc * bv[bo] + ba * bu[bo] + aP * bi[bo] + aO * bg[bo]; ++bo;
                                aL += bC;
                            }
                        } else {
                            var bZ = 1 << aI;
    ...
    aA.prototype.add = function(aD) {
        if (this._$H.length <= this.size) {
            ...
            O._$Jf(this._$H, 0, aC, 0, this.size);
            this._$H = aC;
        }
    ...
    ay.prototype.transform = function(aF, aD, aC) {
        ...
        default:
            return;
        case (ay._$sR | ay._$qR | ay._$sk) : aO = this._$a;
            aN = this._$0;
            aM = this._$I;
            aH = this._$q;
            aG = this._$s;
            ...
            return;
        case (ay._$sR | ay._$qR) : aO = this._$a;
            aN = this._$0;
            aH = this._$q;
            aG = this._$s;
            while (--aC >= 0) {
            ...
            return;
        case (ay._$sR | ay._$sk) : aN = this._$0;
            aM = this._$I;
            aH = this._$q;
            aE = this._$L;
            while (--aC >= 0) {
        ...
        case (ay._$sR):
            ...
            return;
        case (ay._$qR | ay._$sk) : aO = this._$a;
            aM = this._$I;
            aG = this._$s;
            aE = this._$L;
            while (--aC >= 0) {
    ...
    x.prototype.loadParam = function() {
        ...
        O._$Jf(this._$qm, 0, this._$_j, 0, aC);
    };
    x.prototype.saveParam = function() {
        ...
        O._$Jf(this._$_j, 0, this._$qm, 0, aC);
    };
